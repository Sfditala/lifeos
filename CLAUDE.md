...
**الخطوة الحالية: Step 0 — لم تبدأ بعد.**
**الحالة: بانتظار البدء.**
...
- [ ] **Step 0** — تأسيس المشروع + قاعدة البيانات الفارغة + نشر أولي على Vercel
- [ ] **Step 1** — قاعدة البيانات: الهوية، مجالات الحياة، الأهداف، المشاريع، المهام
