...
**الخطوة الحالية: Step 19 — هرمية الأهداف (كبير/سنوي/شهري/أسبوعي) + الصفحة الرئيسية كصفحة أهداف. منجزة، نُشرت على Production. بانتظار تجربة المستخدمة الفعلية قبل الانتقال لـStep 20.**
...
- [ ] **Step 20** — رسوم بيانية حقيقية بكل الوحدات (مال، أهداف، مجالات، مشاريع) — عبر recharts
- [ ] **Step 21** — الشركة الاحترافية: تفاصيل إضافية + أدوار مخصصة + تعيين مهام لأعضاء فريق محددين
- [ ] **Step 22** — تحسينات صغيرة: مدة زمنية على المهمة، تصنيف مصادر دخل منظّم بدل نص حر
- [ ] **تنظيف بيانات شامل** — بعد آخر خطوة، مطلوب صراحة من المستخدمة: مسح كل بيانات الاختبار/التجربة عشان تبلش تستخدم النظام من الصفر ببيانات حقيقية فقط.
